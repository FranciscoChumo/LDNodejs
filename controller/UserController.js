...
export const createUsers = async (req, res) => {
  try {
    const { nombre, apellido, cedula, correo, telefono, especialidad, typepersona_id } = req.body;
    if (!(nombre ||  apellido ||  cedula || correo  || telefono   || especialidad ||typepersona_id)) {
    ...
    const users = await UserModel.create({
      ...
      telefono:  telefono.parseInt(),//sanitize and validate phone number
      especialidad,
      typepersona_id,
    });
    // Create token
